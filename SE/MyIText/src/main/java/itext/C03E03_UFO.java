...
public class C03E03_UFO {
	...
	public static final String DATA = "input/csv/ufo.csv";
	...
	protected class MyEventHandler implements IEventHandler {
		...
		public void handleEvent(Event event) {
			...
			pdfCanvas.beginText().setFontAndSize(helvetica, 9)
					...
					.showText("THE TRUTH IS OUT THERE").moveText(60, -pageSize.getTop() + 30)
			...
			canvas.showTextAligned(new Paragraph("CONFIDENTIAL"), 298, 421, pdfDoc.getPageNumber(page),
					TextAlignment.CENTER, VerticalAlignment.MIDDLE, 1.5f);
			canvas.close();
			pdfCanvas.release();
		}
	}
